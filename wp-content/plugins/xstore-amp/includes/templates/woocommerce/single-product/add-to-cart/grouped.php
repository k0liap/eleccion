...
<form class="cart grouped_form" action-xhr="<?php echo $action_url ?>" method="post" enctype='multipart/form-data' on="submit-success: AMP.setState({'cartCount':event.response.count, 'cartCount_hidden' : event.response.hide_item })">
