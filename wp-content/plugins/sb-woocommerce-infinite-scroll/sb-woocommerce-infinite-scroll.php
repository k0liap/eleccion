...
class SBWIS_WooCommerce_Infinite_Scroll {
	...
	function __construct() {
		...
		$this->sb_admin   = new SBWIS_Infinite_Scroll_Admin($this);
		...
		if(!empty($settings['products_per_page'])) {
			add_filter( 'loop_shop_per_page', function() use ($settings) {
...
$sbwis_infinite_scroll = new SBWIS_WooCommerce_Infinite_Scroll();
