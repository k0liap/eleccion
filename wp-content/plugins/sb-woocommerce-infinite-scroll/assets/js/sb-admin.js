    ...
    sbwis_admin = {
        ...
        import_export_popup: function () {
            ...
            $popup.dialog({
                ...
                buttons: {
                    Close: function () {
                        $popup.html('').addClass('popup-ajax-loader');
                        location.reload();
                    },
                },
            });
