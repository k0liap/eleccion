<?php
	...
	//var_dump('<pre>', $WooZone , '</pre>'); echo __FILE__ . ":" . __LINE__;die . PHP_EOL;
	...
	if ( 'remote_image_size' == $act ) {
		...
		$ret = $WooZone->u->getimagesize( $url );
	...
	if ( 'ebay_remote_images' == $act ) {
		$product_id = 331035;
		$setRemoteImgStatus = $WooZone->get_ws_object( 'generic' )->build_remote_images( $product_id );
