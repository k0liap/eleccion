...
class StreamWrapper
{
     ...
     */
    public static function getResource(\WooZoneVendor\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\WooZoneVendor\Psr\Http\Message\StreamInterface $stream)
    {
