 ...
 */
class FnStream implements \WooZoneVendor\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\WooZoneVendor\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
