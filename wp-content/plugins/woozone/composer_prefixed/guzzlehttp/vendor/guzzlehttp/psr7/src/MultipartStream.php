 ...
 */
class MultipartStream implements \WooZoneVendor\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \WooZoneVendor\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\WooZoneVendor\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \WooZoneVendor\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
