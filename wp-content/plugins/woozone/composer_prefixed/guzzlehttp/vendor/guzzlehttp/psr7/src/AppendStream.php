 ...
 */
class AppendStream implements \WooZoneVendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\WooZoneVendor\Psr\Http\Message\StreamInterface $stream)
    {
