...
//        );
	...
	protected function render() {
        ...
        $fallback_text = '<h1 style="text-align: center;">'.esc_html__('Твій кошик порожній :(', 'xstore-core').'</h1><p style="text-align: center;">'.esc_html__('We invite you to get acquainted with an assortment of our shop. Surely you can find something for yourself!', 'xstore-core').'</p>';
                                ...
                                <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
                                    ...
                                    foreach ( $settings['table_fields'] as $repeater_field ) {
                                        ...
                                        switch ($repeater_field['field_key']) {
                                            case 'details':
                                                ?>
                                                <td class="product-name" data-title="<?php esc_attr_e( 'Product', 'xstore-core' ); ?>">
