...
echo sprintf(esc_html__('Your subscription on %s has been cancelled.', 'subscriptio'), get_option('blogname')) . "\n\n";

echo esc_html__('Details of the cancelled subscription are shown below for your reference:', 'subscriptio') . "\n\n";
