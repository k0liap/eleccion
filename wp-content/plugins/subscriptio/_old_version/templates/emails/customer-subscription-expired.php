...
<p><?php printf(esc_html__('Your subscription on %s has expired.', 'subscriptio'), get_option('blogname')); ?></p>

<p><?php esc_html_e('Details of the expired subscription are shown below for your reference:', 'subscriptio'); ?></p>
