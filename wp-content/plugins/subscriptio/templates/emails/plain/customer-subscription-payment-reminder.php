...
echo wp_kses_post(
    sprintf(
        esc_html__('This is a reminder that payment for your subscription with %1$s is due. Please follow this link to make a payment when you’re ready: %2$s', 'subscriptio'),
