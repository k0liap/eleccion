...
class RP_SUB_Email_Customer_Reactivated_Subscription extends RP_SUB_Subscription_Email
{
    ...
    public function __construct()
    {
        ...
        $this->title            = esc_html__('Subscription reactivated', 'subscriptio');
        $this->description      = esc_html__('Subscription reactivated emails are sent to customers when subscriptions are reactivated after they have been set to cancel at the end of the billing cycle.', 'subscriptio');
    ...
    public function get_default_subject()
    {
        ...
        return sprintf(esc_html__('Your %s subscription has been reactivated', 'subscriptio'), '{site_title}');
    }
    ...
    public function get_default_heading()
    {
        ...
        return esc_html__('Your subscription has been reactivated', 'subscriptio');
    }
