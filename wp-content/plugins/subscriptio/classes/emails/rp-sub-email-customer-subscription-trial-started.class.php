...
class RP_SUB_Email_Customer_Subscription_Trial_Started extends RP_SUB_Subscription_Email
{
    ...
    public function __construct()
    {
        ...
        $this->title            = esc_html__('Subscription trial started', 'subscriptio');
        $this->description      = esc_html__('Subscription trial started emails are sent to customers when subscription trials are started.', 'subscriptio');
    ...
    public function get_default_subject()
    {
        ...
        return sprintf(esc_html__('Your %s subscription trial has started', 'subscriptio'), '{site_title}');
    }
    ...
    public function get_default_heading()
    {
        ...
        return esc_html__('Your subscription trial has started', 'subscriptio');
    }
