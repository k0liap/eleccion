...
//			    'fancy_select_categories' => get_theme_mod('search_category_fancy_select_et-desktop', false), //
    ...
    'etheme_elementor_cart_table' => array(
        'title'     => esc_html__( 'Etheme Cart Table', 'xstore' ),
        'name'      => 'etheme_elementor_cart_table',
        'file'      => '/js/modules/ethemeCartTable.min.js',
        'in_footer' => true
    ),

    'etheme_elementor_checkout_multistep' => array(
        'title'     => esc_html__( 'Etheme Checkout Multistep', 'xstore' ),
        'name'      => 'etheme_elementor_checkout_multistep',
        'file'      => '/js/modules/ethemeCheckoutMultistep.min.js',
        'in_footer' => true
    ),
