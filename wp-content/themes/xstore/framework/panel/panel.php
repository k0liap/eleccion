...
class EthemeAdmin{
    ...
    public function add_page_admin_script(){
        ...
        if (
            ...
            if ( $this->page['template'] == 'theme-builders')
                wp_enqueue_script('etheme_panel_global',ETHEME_BASE_URI.'framework/panel/js/global.min.js', array('jquery','etheme_admin_js'), false,true);
        }
...
//	        }
            ...
            if ( $is_activated && $is_et_core && class_exists('\Elementor\Plugin') ) {
    ...
    public function xstore_panel_icons_list($type = 'simple') {
        $icons = array(
            'simple' => array(
                ...
                'et_icon-phone'           => esc_html__( 'Phone', 'xstore' ),
                ...
                'et_icon-account'         => esc_html__( 'Account', 'xstore' ),
...
//			$local_settings_parsed[ $local_settings_key ][ $setting['name'] ] = $setting['value'];
                ...
                <ul>
                    <?php
                        foreach ($filters_list as $filter_key => $filter_details) {
                            ...
                            ?>
                            <li class="et-filter <?php echo esc_attr($settings['type']); if ( $filter_key == $active_key ) echo ' active'; ?>" data-filter="<?php echo esc_attr($filter_key); ?>">
                                <?php if ( $filter_link ) { ?>
    ...
    public function get_loader($percentage = false) {
        ?>
