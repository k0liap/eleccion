                                    ...
                                    <span class="et-title-label">
                                        <span class="mtips mtips-lg mtips-top helping">
                                            <svg width="1em" height="1em" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M5 0C2.24284 0 0 2.24284 0 5C0 7.75716 2.24284 10 5 10C7.75716 10 10 7.75716 10 5C10 2.24284 7.75716 0 5 0ZM5 0.833333C7.30631 0.833333 9.16667 2.69369 9.16667 5C9.16667 7.30631 7.30631 9.16667 5 9.16667C2.69369 9.16667 0.833333 7.30631 0.833333 5C0.833333 2.69369 2.69369 0.833333 5 0.833333ZM5 2.5C4.08366 2.5 3.33333 3.25033 3.33333 4.16667H4.16667C4.16667 3.70117 4.53451 3.33333 5 3.33333C5.46549 3.33333 5.83333 3.70117 5.83333 4.16667C5.83333 4.48568 5.62826 4.76888 5.32552 4.86979L5.15625 4.92188C4.81608 5.03418 4.58333 5.3597 4.58333 5.71615V6.25H5.41667V5.71615L5.58594 5.66406C6.22721 5.45085 6.66667 4.84212 6.66667 4.16667C6.66667 3.25033 5.91634 2.5 5 2.5ZM4.58333 6.66667V7.5H5.41667V6.66667H4.58333Z" fill="#222222"/>
                                            </svg>
        ...
        <?php if ( !$xstore_branding_settings_inited ) : ?>
            <div class="xstore-panel-grid-item">
                <div class="main-features-slider" style="visibility: hidden; opacity: 0;">
                    <?php
                        for ($i=1; $i<=7; $i++) {
                            echo '<div class="slick-carousel-item"><a href="https://bit.ly/3hewHb7" rel="nofollow" target="_blank"><img src="' .esc_url( ETHEME_BASE_URI.'framework/panel/images/9.2-banner-'.$i.'.jpg' ) . '" alt="'.$settings['brand_label'] . ' 9.2 - ' . $i.'"></a></div>';
                        }
                    ?>
                </div>
                <br/>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M5.98322 11.9664C5.98322 15.2712 8.66201 17.95 11.9664 17.95C15.2712 17.95 17.95 15.2712 17.95 11.9664C17.95 8.662 15.2712 5.9832 11.9664 5.9832V11.9664H5.98322Z" fill="white"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M11.9664 5.9832V0H0V11.9664H5.9832V5.9832H11.9664Z" fill="white"/>
</svg>',
                'title' => esc_html__('Customization Services', 'xstore'),
                'link' => 'https://codeable.io/?ref=qGTdX',
