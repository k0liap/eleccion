...
<div class="mtips mtips-top">
                    <span class="et-button et-button-black et-button-arrow full-width no-loader tooltip-trigger popup-domain-confirm <?php //echo ($is_connection) ? 'enabled' : '';?>">
...
<div class="mtips mtips-top">
                    <span class="et-button et-button-black full-width no-loader tooltip-trigger popup-theme-register hidden">
...
<a href="<?php echo admin_url( 'admin.php?page=et-panel-demos' ); ?>" class="et-button et-button-black et-button-arrow full-width no-loader tooltip-trigger popup-go-to-import hidden enabled"><?php echo esc_html__('Go To Import Demos', 'xstore'); ?>
    <svg class="arrow-icon" xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 32 32">
        <g fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" stroke-miterlimit="10">
            <circle class="arrow-icon--circle" cx="16" cy="16" r="15.12"></circle>
            <path class="arrow-icon--arrow" d="M16.14 9.93L22.21 16l-6.07 6.07M8.23 16h13.98"></path>
