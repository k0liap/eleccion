...
add_filter('elementor/frontend/the_content', function ($content) {
    ...
    elseif ( get_query_var('et_is-checkout', false) ) {
        if (false !== strpos($content, 'etheme-elementor-checkout-widgets-contain')) {
...
//                            $wc_forms.
//                        '</div></div></div></div>';
                    $content = $wc_forms . '<form name="checkout" method="post" class="checkout woocommerce-checkout" action="' . esc_url(wc_get_checkout_url()) . '" enctype="multipart/form-data">' .
                        $content .
                        '</form>';
                }
            endif;
